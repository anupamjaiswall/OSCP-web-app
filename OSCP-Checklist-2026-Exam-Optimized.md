...
> Exam rules last checked against OffSec's official docs: **04 Sep 2026**
>
...
```text
EXAM STRUCTURE (OffSec guide checked 04 Sep 2026)
...
4. **Every credential is a new attack surface.** Test it against all appropriate in-scope services immediately.
...
> Checked against the OffSec OSCP+ Exam Guide, FAQ and AI policy on 04 Sep 2026.
...
**Pivot rule:** OffSec confirms that pivoting may be required in the AD set. Re-enumerate routes and reachable services after each foothold.
    ...
    PHASE 1: UNAUTHENTICATED
      ...
      ├── EXAM: DO NOT use LLMNR/NBT-NS poisoning (prohibited by OffSec)
...
**Version snapshot (04 Sep 2026):** Ligolo-ng 0.9.1 retains the explicit
...
<details>
<summary>📦 17. Buffer Overflow — Windows x86 (Legacy Reference — Click to Expand)</summary>
...
**Re-check these two pages immediately before your exam.** If these notes conflict with the current official guide, the official guide wins.
