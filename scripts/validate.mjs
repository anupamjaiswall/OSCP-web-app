...
let renderedReference='';try{renderedReference=gunzipSync(Buffer.from(payloadText.trim(),'base64')).toString('utf8')}catch(e){fail('Reference payload gzip/base64 is invalid')}
