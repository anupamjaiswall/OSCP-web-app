...
test('snapshot delete binds over the full node list',()=>{const src=read('src/js/03-core-app.js');const a=src.indexOf('function renderSnapshots()');const b=src.indexOf('function renderCockpitRecovery',a);const block=src.slice(a,b);ok(block.includes("$$('.snapDelete').forEach"));ok(!block.includes("$('\.snapDelete').forEach"));});
