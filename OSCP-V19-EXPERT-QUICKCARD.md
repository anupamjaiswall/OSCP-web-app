# OSCP V19 — HIGH-SIGNAL QUICK CARD

> V19 rule: **evidence before CVE, prerequisites before PoC, banked proof before curiosity.**

> **EXAM ONLY:** no training modes, simulations, or prohibited-tool workflows are included.

> Official OSCP+ rules re-checked **06 Sep 2026**. The live OffSec Exam Guide/FAQ always override this offline snapshot. AI/LLM use is prohibited during both the exam and reporting phase.
...
Tool lock checked 06 Sep 2026: Impacket `0.13.1`, NetExec `1.5.1`,
